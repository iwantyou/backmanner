			...
			<aside class="main-sidebar">
				<section class="sidebar">
					<ul class="sidebar-menu" data-widget="tree">
						...
						<li
							@click="cur(index,item)"
							v-for="(item, index) in leftnav"
							:key="index"
							:class="[{'active' : curindex == index},{'treeview': item.twoname}] "
						>
							<a href="/#/web/home">
								<i
									:class="[
		...
		return {
			...
			leftnav: [
				{ name: "首页", url: "/webhome" },
				{
					...
					url: "#",
					twoname: [
						{ name: "创建活动", url: "/webactivity" },
						{ name: "白名单管理", url: "/webwhitelist" },
				...
				{ name: "敏感字处理", url: "/websensitiveword" },
				{
					name: "账户管理",
					url: "#",
